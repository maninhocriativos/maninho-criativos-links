...
export async function createReceiptPdf(receipt, env) {
  ...
  page.drawText('RECIBO DE PRESTACAO DE SERVICOS', { x: 44, y: 775, size: 20, font: bold, color: rgb(1, 1, 1) });
  page.drawText('DOCUMENTO NAO FISCAL', { x: 44, y: 757, size: 8, font: bold, color: rgb(.72, .78, .86) });
  page.drawText(receipt.document_code, { x: 405, y: 783, size: 9, font: bold, color: rgb(1, 1, 1) });
  page.drawText('PRESTADOR DO SERVICO', { x: 44, y: 716, size: 8, font: bold, color: gray });
  ...
  page.drawText('TOMADOR DO SERVICO', { x: 44, y: 608, size: 8, font: bold, color: gray });
  ...
  page.drawText('DESCRICAO DO SERVICO', { x: 60, y: 510, size: 7, font: bold, color: gray });
  ...
  page.drawText('DATA DE EMISSAO', { x: 340, y: 414, size: 8, font: bold, color: gray });
  ...
  page.drawText('Assinatura eletronica do responsavel', { x: 205, y: 193, size: 8, font: regular, color: gray });
  page.drawLine({ start: { x: 44, y: 92 }, end: { x: 551, y: 92 }, thickness: .5, color: rgb(.82, .86, .91) });
  page.drawText(`Documento nao fiscal | Autenticidade: ${receipt.document_code}`, { x: 145, y: 70, size: 8, font: regular, color: gray });
